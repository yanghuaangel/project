...
public class RemoteControllerView extends View {
    ...
    private int rcvInnerCircleColor;
    ...
    private Paint rcvInnerCirclePaint;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(0, 0, Math.min(rcvViewWidth, rcvViewHeight) * SCALE_OF_SMALL_CIRCLE / 2, rcvInnerCirclePaint);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.RemoteControllerView_rcv_stroke_color:
                    ...
                    break;
                case R.styleable.RemoteControllerView_rcv_innercircle_color:
                    rcvInnerCircleColor = typedArray.getColor(attr, Color.BLACK);
                    break;
    ...
    private void initPaints() {
        ...
        rcvInnerCirclePaint = creatPaint(rcvInnerCircleColor, 0, Paint.Style.STROKE, 0);
